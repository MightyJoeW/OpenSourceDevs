...
const About = () => {
  return (
    <div style={{ width: '50%', margin: ' auto' }}>
      <h2 style={{ textAlign: 'center' }}>What is Open Source Allstars?</h2>
      <figure>
        <img src='../..public/content/hack-long.png' alt='' />
      ...
      <p>
        ...
        overwhelming trying to learn the contribution process on your own, so I
        created this project along with a step-by-step guide to guide you
      ...
      <p>
        ...
        `hacktoberfest-accepted`, so pull requests will count towards the four
        required to receive a shirt from Digital Ocean’s Hacktoberfest
        challenge!
      </p>
      <figure>
        <img
          src='../..public/content/hack-long.png'
      ...
      <p>
        No need for a contribution guide? You can fork and clone the Open Source
        Allstars project{' '}
        <Link
